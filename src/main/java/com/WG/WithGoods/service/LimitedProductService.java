...
public class LimitedProductService {
    ...
    public LimitedProductDto get(Integer id) {
        return toDto(limitedProductRepository.findById(id)
    ...
    public LimitedProductDto update(Integer id, LimitedProductDto dto) {
        LimitedProduct limited = limitedProductRepository.findById(id)
