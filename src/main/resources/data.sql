...
VALUES
-- 인형
('푸우 베어 인형', 'https://img.danawa.com/prod_img/500000/399/091/img/25091399_1.jpg?_v=20250412135808', '부드럽고 귀여운 푸우 베어 캐릭터 인형입니다.', 18000, '인형', '소형, 중형, 대형', 'NORMAL', NULL, NULL, NULL, 4.5),
('라이언 인형', 'https://sitem.ssgcdn.com/67/33/94/item/1000521943367_i1_750.jpg', '카카오프렌즈 라이언 인형으로, 안아주기 좋은 크기입니다.', 22000, '인형', '기본형, 한정판', 'NORMAL', NULL, NULL, NULL, 4.8),

-- 문구
('어피치 캐릭터 노트', 'https://m.healthyhmart.com/web/product/big/202312/0fd71662ea100d47360037cc03951d7e.jpg', '어피치 캐릭터가 그려진 귀여운 노트입니다.', 3500, '문구', '줄노트, 무지노트', 'NORMAL', NULL, NULL, NULL, 4.2),
('BT21 펜세트', 'https://image.yes24.com/goods/113842439/XL', 'BT21 캐릭터 펜 5종 세트입니다.', 9000, '문구', '흑색잉크, 컬러잉크', 'NORMAL', NULL, NULL, NULL, 4.4),

-- 패션
('포켓몬 후드티', 'https://newera1920.jpg2.kr/event/collection_sum_kidspokemonhoodie.jpg', '따뜻하고 귀여운 포켓몬 캐릭터 후드티입니다.', 39000, '패션', 'S, M, L, XL', 'NORMAL', NULL, NULL, NULL, 4.7),
('헬로키티 양말', 'https://m.gloomy.co.kr/web/product/Images/47/DDA003AA0047137/big_52717432752ae9e6b63533.jpg', '헬로키티 디자인의 포근한 양말입니다.', 4500, '패션', '230mm, 250mm, 270mm', 'NORMAL', NULL, NULL, NULL, 4.3),

-- 키링
('카카오프렌즈 키링', 'https://akaikaze00.cafe24.com/web/product/big/20200502/d16cd419f0b66bdf163ef248a5c48fb4.jpg', '라이언, 무지 등 다양한 캐릭터 키링이 포함된 제품입니다.', 7000, '키링', '라이언, 무지, 어피치', 'NORMAL', NULL, NULL, NULL, 4.6),
('산리오 키링 세트', 'https://gloomyopen2.iwinv.net/img/202208/san_arc_keyring_1000.jpg', '마이멜로디와 쿠로미가 포함된 산리오 키링 세트입니다.', 12000, '키링', '세트, 단품', 'NORMAL', NULL, NULL, NULL, 4.4),

-- 가전
('휴대용 선풍기', 'https://t1.kakaocdn.net/friends/prod/product/20220107134036052_8809814922230_TH_05.jpg', '귀여운 캐릭터 디자인의 휴대용 선풍기입니다.', 15000, '가전', '색상: 핑크, 화이트', 'NORMAL', NULL, NULL, NULL, 4.1),
('캐릭터 무드등', 'https://image.yes24.com/goods/113842439/XL', 'LED 조명이 내장된 캐릭터 무드등입니다.', 28000, '가전', '조명색: 웜화이트, 화이트', 'NORMAL', NULL, NULL, NULL, 4.5),

-- 한정판 상품
('한정판 유니콘 키링', 'https://cafe24.poxo.com/ec01/kimsohyun89/UVTjSep0dwP4/wX7AtHyXHMaLfGrZEQEydEJn4kK4KHpo+6HgsWh6KxM6f4Sv3gaoHCLOWTMuSPi6wSy+XNzRA==/_/web/product/big/201810/2e9fb041fb403de3c106978ce8d74816.jpg', '형광 컬러가 포인트인 유니콘 키링.', 8000, '키링', '재질: 아크릴, 색상: 무지개', 'LIMITED', '2025-07-01 00:00:00', '2025-07-20 23:59:59', 120, 4.9),
('한정판 미니 곰돌이 키링', 'https://contents.kyobobook.co.kr/sih/fit-in/400x0/gift/pdt/1975/S1672147723500.jpg', '미니 곰돌이 인형이 달린 귀여운 키링.', 9500, '키링', '색상: 베이지, 고리 포함', 'LIMITED', '2025-06-10 00:00:00', '2025-06-30 23:59:59', 90, 4.7),
('한정판 무드등 스피커', 'https://t1.kakaocdn.net/friends/prod/product/20220107134036052_8809814922230_BW_04.jpg', '무드등과 블루투스 스피커가 결합된 한정판 제품.', 42000, '가전', '색상: 화이트, 무드 기능 포함', 'LIMITED', '2025-06-12 00:00:00', '2025-07-01 23:59:59', 50, 4.8),
('한정판 미니 선풍기', 'https://cdn.imweb.me/thumbnail/20230604/b58a987279c01.jpg', '여름 한정판 USB 충전식 미니 선풍기.', 17000, '가전', '색상: 민트, 속도조절: 3단계', 'LIMITED', '2025-06-01 00:00:00', '2025-06-25 23:59:59', 200, 4.6);
